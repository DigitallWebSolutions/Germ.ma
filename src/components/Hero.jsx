      ...
      <section className="bg-gradient-to-br from-yellow-400 via-red-500 to-yellow-500 px-4 py-8">
        <div className="max-w-md mx-auto">
          <button
            ...
            className="w-full bg-white text-red-600 font-bold text-lg py-4 rounded-full shadow-2xl hover:scale-105 active:scale-95 transition-all duration-200 mb-6"
          >
            طلب الحزمة الآن
          </button>

          <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-6 text-center text-white">
